...
class TestULDMHalo_trunc(object):
...
<<<<<<< HEAD:tests/test_halos/test_uldm_tnfw.py
        profile_args = {'log10_m_uldm': -22.1, 'uldm_plaw': 1/3, 'nfw_mdef': 'TNFW'}
...
>>>>>>> 02ff2dfdcf328fb6e4e6f8f36025e99d1ebfbfb3:tests/test_halos/test_uldm.py
